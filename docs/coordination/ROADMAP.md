...
7. 🧪 **Confirmación de reserva por email y datos de gestión.** Código y clave criptográfica visibles con aviso de captura; email HTML/texto con los datos y enlace de gestión; despacho idempotente mediante proveedor configurado. Compilado, pendiente prueba real tras despliegue.
...
12. 🧪 **Autocancelación de la clienta.** Gestión mediante código+clave, vista previa sin revelar datos antes de validar, confirmación final y plazo configurable; email incluye enlace directo. La recuperación alternativa por envío de enlace queda como mejora posterior por requerir token de un solo uso.
