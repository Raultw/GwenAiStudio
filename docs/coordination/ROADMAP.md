...
4. 🔄 **Cambio y restablecimiento de contraseña seguros.** Hacer una sola operación para guardar clave, cerrar sesiones anteriores y auditar; resolver competencia entre login/reset y fallos parciales. Diseño preparado, implementación pendiente.
