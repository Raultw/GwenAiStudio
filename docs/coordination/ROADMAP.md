...
7. 🧪 **Confirmación de reserva por email y datos de gestión.** Código y clave criptográfica visibles con aviso de captura; email HTML/texto con los datos y enlace de gestión; despacho idempotente mediante proveedor configurado. Desplegado; pendiente confirmar una entrega real generando una reserva de prueba.
