...
4. 🔄 **Cambio y restablecimiento de contraseña seguros.** Reset administrativo implementado en e1b919a con nueve casos SQL/fs simulados aprobados. Pendientes cambio propio transaccional, competencia login/reset, rutas alternativas y pruebas PostgreSQL/QA desplegado.
